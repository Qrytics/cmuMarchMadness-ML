...
def main():
    ...
    # Kaggle combined submission (ID, Pred format — separate from CMU files)
    copy_file(os.path.join(PREDS_DIR, "submission.csv"), os.path.join(DOCS_DATA_DIR, "KaggleSubmission.csv"))
